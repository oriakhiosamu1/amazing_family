		...
		<li data-bg-image="{{ asset('images/slide-1.jpg') }}">
			<div class="container">
				<div class="slide-content">
					...
					<h2 class="slide-title">We Are For Signs And Wonders From The Lord</h2>

					<a href="{{ route('signin') }}" class="custom_button">Join Us Today</a>
				</div>
			</div>
		</li>
		...
		<li data-bg-image="{{ asset('images/slide-1.jpg') }}">
			<div class="container">
				<div class="slide-content">
					...
					<a href="{{ route('signin') }}" class="custom_button">Already A Family?</a>
				</div>
			</div>
		</li>
	</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="news">
						<image class="news-image" src="{{ asset('images/news-thumb-1.jpg') }}"></image>
						<h3 class="news-title"><a href="#">Apostle Daniel Oghenechohwo Ohwafosa</a></h3>
						<small class="date"><i class="fa fa-calendar"></i>President/Founder</small>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="news">
						<image class="news-image" src="{{ asset('images/news-thumb-2.jpg') }}"></image>
						<h3 class="news-title"><a href="#">Pastor(Mrs) Sandra Okeoghene Ohwofasa</a></h3>
						<small class="date"><i class="fa fa-calendar"></i>Vice President</small>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="news">
						<image class="news-image" src="{{ asset('images/news-thumb-3.jpg') }}"></image>
				...
				<div class="col-md-3 col-sm-6">
					<div class="news">
						<image class="news-image" src="{{ asset('images/news-thumb-4.jpg') }}"></image>
						<h3 class="news-title"><a href="#">laboris nisi ut aliquip</a></h3>
						<small class="date"><i class="fa fa-calendar"></i>24 mar 2014</small>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<ul class="seremon-list">
						<li>
							<img src="{{ asset('images/small-thumb-1.jpg') }}" alt="">
						...
						<li>
							<img src="{{ asset('images/small-thumb-2.jpg') }}" alt="">
							<div class="seremon-detail">
						...
						<li>
							<img src="{{ asset('images/small-thumb-3.jpg') }}" alt="">
							<div class="seremon-detail">
